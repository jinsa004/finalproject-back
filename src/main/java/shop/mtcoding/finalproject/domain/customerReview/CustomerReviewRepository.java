...
public interface CustomerReviewRepository extends JpaRepository<CustomerReview, Long> {
        ...
        @Query(value = "select count(s.id) count, avg(cr.star_point) starPoint, s.id storeId from customer_reviews cr right outer join stores s on cr.store_id =s.id group by s.id", nativeQuery = true)
