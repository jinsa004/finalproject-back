...
public class DevInit extends DummyEntity {
        ...
        public CommandLineRunner dataSetting(UserRepository userRepository,
                ...
                return (args) -> {
                        ...
                        // User pipi = userRepository.save(newUser("pipi", UserEnum.CEO));
                        // User gimhae1 = userRepository.save(newGimhaeUser("gimhae1",
                        // UserEnum.CUSTOMER));
                        // User gimhae2 = userRepository.save(newGimhaeUser("gimhae2",
                        // UserEnum.CUSTOMER));
                        // Store store1 = storeRepository.save(newStore(ssar, "그린치킨",
                        // StoreCategoryEnum.CHICKEN,
                        // "assets/images/store_thumbnail/네네치킨.png"));
                        // Store store2 = storeRepository.save(newStore(cos, "레드치킨",
                        // StoreCategoryEnum.CHICKEN,
                        // "assets/images/store_thumbnail/희치킨.png"));
                        // Store store3 = storeRepository.save(newApplyStore(hoho));
                        // Store store4 = storeRepository.save(newStore(haha, "그린피자",
                        // StoreCategoryEnum.PIZZA,
                        // "assets/images/store_thumbnail/피자.jpg"));
                        // Store store5 = storeRepository.save(newStore(koko, "그린버거",
                        // StoreCategoryEnum.BURGER,
                        // "assets/images/store_thumbnail/로고.png"));
                        // Store store6 = storeRepository.save(newStore(kaka, "그린분식",
                        // StoreCategoryEnum.SCHOOLFOOD,
                        // "assets/images/store_thumbnail/분식.jpg"));
                        // Store store7 = storeRepository.save(newStore(hihi, "그린한식",
                        // StoreCategoryEnum.KRFOOD,
                        // "assets/images/store_thumbnail/한식.jpg"));
                        // Store store8 = storeRepository.save(newStore(kiki, "그린중식",
                        // StoreCategoryEnum.CNFOOD,
                        // "assets/images/store_thumbnail/중식.jpg"));
                        // Store store9 = storeRepository.save(newStore(papa, "그린일식",
                        // StoreCategoryEnum.JPFOOD,
                        // "assets/images/store_thumbnail/일식.jpg"));
                        // Store store10 = storeRepository.save(newStore(popo, "그린보쌈",
                        // StoreCategoryEnum.BOSSAM,
                        // "assets/images/store_thumbnail/보쌈.jpg"));
                        // Store store11 = storeRepository.save(newStore(pepe, "그린죽",
                        // StoreCategoryEnum.PORRIDGE,
                        ...
                        // Order order1 = orderRepository.save(
                        // newOrder(jinsa, store1, OrderStateEnum.COMPLETE,
                        // DeliveryStateEnum.DELIVERY));
                        // Order order2 = orderRepository.save(
                        ...
                        // Order order5 = orderRepository.save(
                        // newOrder(jinsa, store2, OrderStateEnum.COMPLETE,
                        // DeliveryStateEnum.DELIVERY));
                        // Order order6 = orderRepository.save(
                        // newOrder(jinsa, store4, OrderStateEnum.COMPLETE,
                        // DeliveryStateEnum.DELIVERY));
                        // Order order7 = orderRepository.save(
                        // newOrder(jinsa, store5, OrderStateEnum.COMPLETE,
                        // DeliveryStateEnum.DELIVERY));
                        // Order order8 = orderRepository.save(
                        // newOrder(jinsa, store6, OrderStateEnum.COMPLETE,
                        // DeliveryStateEnum.DELIVERY));
                        // Order order9 = orderRepository.save(
                        // newOrder(jinsa, store7, OrderStateEnum.COMPLETE,
                        // DeliveryStateEnum.DELIVERY));
                        // Order order10 = orderRepository.save(
                        // newOrder(jinsa, store8, OrderStateEnum.COMPLETE,
                        // DeliveryStateEnum.DELIVERY));
                        // Order order11 = orderRepository.save(
                        // newOrder(jinsa, store9, OrderStateEnum.COMPLETE,
                        // DeliveryStateEnum.DELIVERY));
                        // Order order12 = orderRepository.save(
                        // newOrder(jinsa, store10, OrderStateEnum.COMPLETE,
                        // DeliveryStateEnum.DELIVERY));
                        // Order order13 = orderRepository.save(
                        // newOrder(jinsa, store11, OrderStateEnum.COMPLETE,
                        // DeliveryStateEnum.DELIVERY));
                        // OrderDetail orderDetail1 = orderDetailRepository.save(newOrderDetail(order1,
                        // menu1));
                        // OrderDetail orderDetail2 = orderDetailRepository.save(newOrderDetail(order1,
                        // menu2));
                        // OrderDetail orderDetail3 = orderDetailRepository.save(newOrderDetail(order2,
                        // menu1));
                        // OrderDetail orderDetail4 = orderDetailRepository.save(newOrderDetail(order3,
                        // menu1));
                        // OrderDetail orderDetail5 = orderDetailRepository.save(newOrderDetail(order4,
                        // menu3));
                        // OrderDetail orderDetail6 = orderDetailRepository.save(newOrderDetail(order5,
                        // menu3));
                        // OrderDetail orderDetail7 = orderDetailRepository.save(newOrderDetail(order5,
                        // menu2));
                        // OrderDetail orderDetail8 = orderDetailRepository.save(newOrderDetail(order6,
                        // menu4));
                        // OrderDetail orderDetail9 = orderDetailRepository.save(newOrderDetail(order7,
                        // menu5));
                        // OrderDetail orderDetail10 = orderDetailRepository.save(newOrderDetail(order8,
                        // menu6));
                        // OrderDetail orderDetail11 = orderDetailRepository.save(newOrderDetail(order9,
                        // menu7));
                        // OrderDetail orderDetail12 =
                        // orderDetailRepository.save(newOrderDetail(order10, menu8));
                        // OrderDetail orderDetail13 =
                        // orderDetailRepository.save(newOrderDetail(order11, menu9));
                        // OrderDetail orderDetail14 =
                        // orderDetailRepository.save(newOrderDetail(order12, menu10));
                        // OrderDetail orderDetail15 =
                        // orderDetailRepository.save(newOrderDetail(order13, menu11));
                        // CeoReview ceoReview = ceoReviewRepository.save(newCeoReview(store1, order1));
                        // CeoReview ceoReview2 = ceoReviewRepository.save(newCeoReview(store1,
                        // order2));
                        // CustomerReview customerReview = customerReviewRepository
